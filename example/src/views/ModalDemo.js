  ...
  render() {
    return (
      <ScrollView>
        ...
        <ButtonRadio value={this.state.placement} options={['center', 'bottom', 'top', 'left', 'right']} onPress={this.handleChangePlacement} />
        ...
        <ButtonRadio value={this.state.width} options={[ {label: '"80"', value: '80'}, {label: '"50"', value: '50'}, {label: '"100"', value: '100'}, 150, 200, 300]} onPress={this.handleChangeWidth} />

        <Text style={styles.title}>maskBgColor</Text>
        <ButtonRadio value={this.state.maskBgColor} options={['transparent', 'red', '#90ea3d', 'rgba(0,0,0,.6)', 'rgba(101,0,212,.5)']} onPress={this.handleChangeMaskBgColor} size="sm" />


        <Text style={styles.title}>closable</Text>
        <ButtonRadio value={this.state.closable} options={[{ label: 'false', value: false }, { label: 'true', value: true }]} onPress={this.handleChangeClosable} />

        <Text style={styles.title}>maskClosable</Text>
        <ButtonRadio value={this.state.maskClosable} options={[{ label: 'false', value: false }, { label: 'true', value: true }]} onPress={this.handleChangeMaskClosable} />
