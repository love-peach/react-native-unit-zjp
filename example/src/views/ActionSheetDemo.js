...
import { ButtonGroup, Button, Modal, ActionSheet } from '../components';
  ...
  render() {
    return (
      <ScrollView>
        ...
        <ActionSheet visible={this.state.modal1} onClosePress={this.setModalVisibleByKey.bind(this, 'modal1', false)}>
          {this.renderDemoText()}
